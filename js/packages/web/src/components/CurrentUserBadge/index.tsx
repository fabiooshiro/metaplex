      ...
      <div style={{ maxWidth: '100%' }}>
        ...
        >
          ...
          <span>
            ...
            >
              <img src={`${process.env.NEXT_PUBLIC_FRONT_BASE_URL}/sol.svg`} width="10" />
            </span>{' '}
            SOL
          </span>
        </div>
        ...
        >
          ...
          >
            ...
            <img src={`${process.env.NEXT_PUBLIC_FRONT_BASE_URL}/ftxpay.png`} width="80" />
          </div>
        </Button>
      </div>
    </MetaplexModal>
...
export const Cog = () => {
  ...
  return (
    <div className="wallet-wrapper">
      ...
      >
        <Button className="wallet-key">
          <img src={`${process.env.NEXT_PUBLIC_FRONT_BASE_URL}/cog.svg`} />
        </Button>
      </Popover>
    </div>
  );
